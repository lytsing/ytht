...
function writeButtons(rte) {
	...
	document.writeln(aStr+'bold.gif" alt="粗體" title="粗體" onClick="FormatText(\'' + rte + '\', \'bold\', \'\')"></td>'
	+aStr+'italic.gif" alt="斜體" title="斜體" onClick="FormatText(\'' + rte + '\', \'italic\', \'\')"></td>'
	+aStr+'underline.gif" alt="下劃線" title="下劃線" onClick="FormatText(\'' + rte + '\', \'underline\', \'\')"></td>'
	+vertSep
	+aStr+'left_just.gif" alt="左對齊" title="左對齊" onClick="FormatText(\'' + rte + '\', \'justifyleft\', \'\')"></td>'
	+aStr+'centre.gif" alt="居中" title="居中" onClick="FormatText(\'' + rte + '\', \'justifycenter\', \'\')"></td>'
	+aStr+'right_just.gif" alt="右對齊" title="右對齊" onClick="FormatText(\'' + rte + '\', \'justifyright\', \'\')"></td>'
	+aStr+'justifyfull.gif" alt="兩端對齊" title="兩端對齊" onclick="FormatText(\'' + rte + '\', \'justifyfull\', \'\')"></td>'
	+vertSep
...
function writeRTE(rte, html, width, height, buttons, readOnly) {
	...
	if (buttons == true) {
		...
		if (!readOnly)
			document.writeln('<input type="checkbox" id="chkSrc' + rte + '" onclick="toggleHTMLSrc(\'' + rte + '\');" />&nbsp;查看源碼');
...
function enableDesignMode(rte, html, readOnly) {
	...
	frameHtml += "<style>body {background: #FFFFFF;margin: 10px;padding:0px;font-family:宋體;}\n"
