...
void PPrintAttribute(Out *fout, uint indent, Node *node, AttVal *attr)
{
    char *name;
    Bool wrappable = no;
...
void PPrintAttrs(Out *fout, uint indent, Lexer *lexer, Node *node, AttVal *attr)
{
    if (attr)
    {
        if (attr->next)
...
void PPrintJste(Out *fout, uint indent,
                   Lexer *lexer, Node *node)
{
    int savewraplen = wraplen;
...
void PPrintPhp(Out *fout, uint indent,
                   Lexer *lexer, Node *node)
{
    int savewraplen = wraplen;
...
void PPrintCDATA(Out *fout, uint indent,
                   Lexer *lexer, Node *node)
{
    int savewraplen = wraplen;
...
void PPrintSection(Out *fout, uint indent,
                   Lexer *lexer, Node *node)
{
    int savewraplen = wraplen;
